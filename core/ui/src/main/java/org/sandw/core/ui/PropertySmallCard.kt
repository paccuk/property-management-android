...
import org.sandw.core.designsystem.theme.PmaTheme
...
fun PropertySmallCard(
    ...
    Card(
        ...
        Column {
            if (!userProperty.headerImageUrl.isNullOrEmpty()) {
                Row {
                    UserPropertyHeaderImage(userProperty.headerImageUrl)
                }
            }
            Box(
...
//                    Spacer(modifier = Modifier.height(16.dp))
                    PropertyStreet(userProperty.street)
//                    Spacer(modifier = Modifier.height(16.dp))
                    PropertyCity(userProperty.city)
                }
            }
        }
    }
...
fun PropertySmallCardPreview(
    ...
    CompositionLocalProvider(
        ...
        PmaTheme {
            Surface {
                PropertySmallCard(
                    userProperty = userProperties.first(),
                    onClick = {},
                )
            }
        }
